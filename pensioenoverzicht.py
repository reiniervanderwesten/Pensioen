...
def pensioenstatus(a,b):    #bij deze functie horen de 2 argumenten leeftijd en werkstatuut. Zie hiervoor regel 32.
    if a<65:        # De situatie dat iemand beneden de pensioengerechtigde leeftijd zit. 
        ...
        D2= 65-a    # als D1 'False' is, d.w.z. er is geen recht op pensioen, dan geeft D2 het aantal jaren weer dat iemand nog moet werken. 
    ...
    if 70>a>=65 and b=="ambtenaar":
        D1=True
        D2=370
    if  a>=70 and b=="medewerker":  # regel 19 t/m 27 geeft de situatie weer dat iemand boven de 70 is en recht heeft op het 'hoge' pensioen binnen 1 van de beroepsgroepen.
        D1=True
        D2=370
...
if recht_op_pensioen==False:
    print(f"Van werken wordt je gelukkig, je mag nog {pensionado_vs_arbeider} jaar genieten van je baan.")
if recht_op_pensioen==True:
    print(f"Je krijgt  € {pensionado_vs_arbeider} per week.")